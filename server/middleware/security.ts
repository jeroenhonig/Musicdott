...
// This allows legitimate users to login without depleting the quota while still
// protecting against brute-force attacks (which always involve failed attempts).
