...
import { normalizeYouTubeEmbed } from "@shared/utils/index";
import { assertHardGuarantees } from "../utils/embed-test-helpers";
import fixturesData from "../fixtures/youtube_embed_fixtures.json";
...
describe("normalizeYouTubeEmbed fixtures", () => {
  const fixtures = (fixturesData as { cases: FixtureCase[] }).cases;

  it("enforces hard guarantees", () => {
    for (const fixture of fixtures) {
      const output = normalizeYouTubeEmbed(fixture.input.raw);
