 ...
 * - vervangt:
 *   - <iframe ...groove...>
 *   - http(s)://(teacher.musicdott.com|mikeslessons.com)/... met TimeSig
 *   - regels die starten met ?TimeSig= of TimeSig=
 */
